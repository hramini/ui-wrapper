...
export { IElementOption, IFrameElementOption, ITagElementOption } from './type/element-option-interface';
...
export { IElement, IUnit, IUnitAlterStateOptions, IUnitOnBeforeUpdateCheck, IUnitSetPropertiesOptions } from './unit/unit-interface';
